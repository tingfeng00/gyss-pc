        ...
        <div class="main clearfix">
            <div class="pc-left l">
                <div class="c_left_menu_wrapper1">
                    <div class="treetitle"> 
                        <p><img src="../assets/book-icon.png">老年大学</p>
                    </div>
				</div>
...
import { CourseList2 } from '../service/getData'
...
export default {
    ...
    methods: {
        ...
        async getCourseChannel () {
            ...
            let list1 = [
                {
                    Image: "/Content/Upload/Image/Course/Save/3d33fdae-56a0-46c2-9345-c0508cd81216.jpg",
                    SunFlag: true,
                    Type: null,
                    children: [
                        { SunFlag: false, children: null, id: 133, state: "open", text: "音乐戏曲", Type: null, Image: "" },
                        { SunFlag: false, children: null, id: 121, state: "open", text: "其它运动", Type: null, Image: "" },
                        { SunFlag: false, children: null, id: 156, state: "open", text: "体育健身", Type: null, Image: "" }
                    ],
                    id: 89,
                    state: "closed",
                    text: "老年大学"
